...
#
# Trigger note: rerun this same post-arc observation after the exact-owner Create contact-carry
# landing refresh candidate. This trace remains telemetry-only and does not alter that hypothesis.
anchor = '''            LOGGER.info(\n                "GATE_E_CLIENT_STATE'''
...
print("REFERENCE_OWNER_V2_POST_ARC_TRACE prepared=true read_only=true owner_state_only=true trigger=exact_owner_grounded_refresh")

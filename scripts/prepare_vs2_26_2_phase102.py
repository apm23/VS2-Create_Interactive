...
# assembled train, inspect the exact native-hit cell and its six adjacent cells in the
# live contraption block map, plus map implementation/size and bounds. Read-only only.
anchor = '''                                                        LOGGER.info(
...
replacement = anchor + '''
                                                        try {
                                                            ...
                                                            net.minecraft.core.BlockPos hitLocal = syntheticContraptionHit.getBlockPos();
                                                            ...
                                                            LOGGER.info(
                                                                ...
                                                                hitLocal, liveBlocks != null && liveBlocks.containsKey(hitLocal),
...
print("Phase 102: inspected exact moving-train contraption block-map occupancy and adjacent placement cells read-only")

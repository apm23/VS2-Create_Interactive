...
# Production-world #670-#672 prove the reset must sit completely outside the exact cumulative
# Phase165 walk-start anchor consumed after Phase203. Keep it in the same callback, immediately
# before phase154WalkPreviousLocal, so the entire Phase165 block remains composition-stable.

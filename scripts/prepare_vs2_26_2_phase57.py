...
# Runtime proof on Run 52 showed the real LocalPlayer is classified SERVER by Create Fly,
# which makes ContraptionCollider skip it. Chain the minimal client-only compat correction.
runpy.run_path(str(Path(__file__).with_name("prepare_vs2_26_2_phase58.py")), run_name="__main__")

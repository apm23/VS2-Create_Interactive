...
# Phase 94 consumes the exact local hit produced here and validates the transformed
# world-space face normal before any synthetic targeting or interaction is attempted.
runpy.run_path(str(Path(__file__).with_name("prepare_vs2_26_2_phase94.py")), run_name="__main__")
